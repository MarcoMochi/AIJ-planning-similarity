...
{map(VAR_id1, VAR_id2, VAR_notes1, VAR_notes2) : node(VAR_id2, VAR_original2, "../problems-mcrx-j/satellite/domain_mum.pddl", VAR_name1, VAR_type, VAR_elements1, VAR_notes1), node(VAR_id1, _, "../problems-mcrx-j/satellite/domain.pddl", _, VAR_type, VAR_elements1, VAR_notes2)} = 1 :- node(VAR_id1, _, "../problems-mcrx-j/satellite/domain.pddl", _, VAR_type, _, _).
 :- node(VAR_id, _, "../problems-mcrx-j/satellite/domain_mum.pddl", _, _, _, _); #count{VAR_v : map(VAR_v, VAR_id, X5a97ea2da2d542a9b5b1464f4f13cd9f, X2248388d7a4e45439164fa7b10244e24)} != 1.
...
edge(500, 0, "../problems-mcrx-j/satellite/domain_mum.pddl", VAR_2, VAR_4, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, Xcdcc0241b19348c6890aa9ed26b05b2e, Xb5e0d716dc9849e98869426bf4542462); map(VAR_3, VAR_4, X331bfc1d912447e987e579b6aecc24a3, X901a1b3557ac47609274d5d1a1a25126); edge(_, 1, "../problems-mcrx-j/satellite/domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation); not edge(_, 1, "../problems-mcrx-j/satellite/domain_mum.pddl", VAR_2, VAR_4, VAR_label, VAR_relation).
edge(500, 0, "../problems-mcrx-j/satellite/domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, X04bfc925b04448b19a64be8e6914b283, X54d45331763f4655816036b4a01de249); map(VAR_3, VAR_4, Xab13f82df06049b3bad790886ba2ddba, X6d833473df61416c9e2045b95136243f); edge(_, 1, "../problems-mcrx-j/satellite/domain_mum.pddl", VAR_2, VAR_4, VAR_label, VAR_relation); not edge(_, 1, "../problems-mcrx-j/satellite/domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation).
