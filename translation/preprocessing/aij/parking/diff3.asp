...
toMap(VAR_N1, VAR_N2) :- map(VAR_N1, VAR_N2, X631bc748e2194c98a749053dcbeaf70a, X926b30f1edff45c08b2e96718ca52e0e); node(VAR_N1, _, "parking", _, "type(Operator,Durative)", _, _).
...
duration(VAR_N1, 1, "parking", "Natural", VAR_V1, "('Function';'Natural')") :- toMap(VAR_N1, VAR_N2); duration(VAR_N2, _, "parking_2", "Natural", VAR_V1, _); duration(VAR_N1, _, "parking", "Function", _, _).
 ...
 :- duration(VAR_Id, _, "parking_2", _, _, _); #count{VAR_V : mapDuration(VAR_V, VAR_Id, X2c8452a0b05240af8b795a4b58c03c52, X2581e23c9dd8463dab8781dac43f6edb)} != 1.
 :- node(VAR_id, _, "parking_2", _, _, _, _); #count{VAR_v : map(VAR_v, VAR_id, Xcc9f0d616076491b8c54ae4e61ca0d40, X011fd05a1a4a4e0d8a3e20d6213b610f)} != 1.
 :- #sum{1,VAR_id : node(VAR_id, _, "parking", _, _, _, _); -1,VAR_id : node(VAR_id, _, "parking_2", _, _, _, _)} != 0.
edge(500, 0, "parking_2", VAR_2, VAR_4, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, Xa6267efcd0ea41c68a10d36154269170, X0a5ea23c4f9c4a1eaf5130dcdc923a8e); map(VAR_3, VAR_4, Xd11a5592359744129bc57bb51bfd9812, Xb5674f1d9fcd4690b49e05286c9ba8f8); edge(_, 1, "parking", VAR_1, VAR_3, VAR_label, VAR_relation); not edge(_, 1, "parking_2", VAR_2, VAR_4, VAR_label, VAR_relation).
edge(500, 0, "parking", VAR_1, VAR_3, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, X3ed67424048148948bb13d574624e235, X6d9c9b25a90b43158481f8b7649baf87); map(VAR_3, VAR_4, Xd214a573183c4e9b988abf04a5ffa2a1, X163c2873193740b3970cae85326baa1d); edge(_, 1, "parking_2", VAR_2, VAR_4, VAR_label, VAR_relation); not edge(_, 1, "parking", VAR_1, VAR_3, VAR_label, VAR_relation).
