...
toMap(VAR_N1, VAR_N2) :- map(VAR_N1, VAR_N2, Xde7aa6806d634e8f92aa1cd6de29d5b6, X872f529759c5454388371302bf67be32); node(VAR_N1, _, "pfile0", _, "type(Operator,Durative)", _, _).
...
duration(VAR_N1, 1, "pfile0", "Natural", VAR_V1, "('Function';'Natural')") :- toMap(VAR_N1, VAR_N2); duration(VAR_N2, _, "pfile1", "Natural", VAR_V1, _); duration(VAR_N1, _, "pfile0", "Function", _, _).
 ...
 :- duration(VAR_Id, _, "pfile1", _, _, _); #count{VAR_V : mapDuration(VAR_V, VAR_Id, X9a2b93bcd1ed49d4a216d04873db713e, X68125951c2c04922b4b76af852c7cfa4)} != 1.
 :- node(VAR_id, _, "pfile1", _, _, _, _); #count{VAR_v : map(VAR_v, VAR_id, Xcbe92f0710ae45fa9bd76022d7ddff6b, X5e4634a0867243c4b2fd50ede190de68)} != 1.
 :- #sum{1,VAR_id : node(VAR_id, _, "pfile0", _, _, _, _); -1,VAR_id : node(VAR_id, _, "pfile1", _, _, _, _)} != 0.
edge(500, 0, "pfile1", VAR_2, VAR_4, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, Xb2eb3fe9eb914d738856cab34f406097, X33d5608b2a9647d6803b2131151df6fa); map(VAR_3, VAR_4, X5e576eade9bd43af9f683011961a3965, X19590d274e6c499dadf345925333d75b); edge(_, 1, "pfile0", VAR_1, VAR_3, VAR_label, VAR_relation); not edge(_, 1, "pfile1", VAR_2, VAR_4, VAR_label, VAR_relation).
edge(500, 0, "pfile0", VAR_1, VAR_3, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, Xbd157b523fdb4a788b36c3302b5920f1, X13e51ea7b59943228428adf39d7bbe3f); map(VAR_3, VAR_4, Xe7c30b04bd964040886329006aa9852b, X655327376df7400a98263e96af607e15); edge(_, 1, "pfile1", VAR_2, VAR_4, VAR_label, VAR_relation); not edge(_, 1, "pfile0", VAR_1, VAR_3, VAR_label, VAR_relation).
