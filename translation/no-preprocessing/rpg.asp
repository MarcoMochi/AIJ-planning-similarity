...
{elementToElement("", "L1,L2", "Predicate")}.
{elementToElement("", "R1", "Predicate")}.
{elementToElement("", "R1,R2", "Predicate")}.
{elementToElement("", "L1", "Predicate")}.
{elementToElement("", "O1", "Predicate")}.
{elementToElement("L1,L2", "R1", "Predicate")}.
{elementToElement("L1,L2", "R1,R2", "Predicate")}.
...
{elementToElement("L1", "O1", "Predicate")}.
...
node(7, 1, "rpggame_domain.pddl", "holding_sword", "Predicate", "", ('empty', 'empty')).
node(8, 1, "rpggame_domain.pddl", "empty_handed", "Predicate", "", ('empty', 'empty')).
...
{map(VAR_id1, VAR_id2, VAR_notes1, VAR_notes2) : node(VAR_id2, VAR_original2, "rpggame_domain.pddl", VAR_name1, VAR_type, VAR_elements1, VAR_notes1)} = 1 :- node(VAR_id1, _, "rpg-domain-NoNeg.pddl.txt", _, VAR_type, VAR_elements1, VAR_notes2).
node(VAR_id, 1, VAR_graph, VAR_name, VAR_type, VAR_elements1, (VAR_elements2, VAR_elements1)) :- node(VAR_id, 1, VAR_graph, VAR_name, VAR_type, VAR_elements2, _); elementToElement(VAR_elements2, VAR_elements1, VAR_type).
 :- node(VAR_id, _, "rpggame_domain.pddl", _, _, _, _); #count{VAR_v : map(VAR_v, VAR_id, Xeb5f8726405f48a6b2b1642bf9e602d2, X35f6eb6b0a4c490ba9a1647bad215a29)} != 1.
 :- #sum{1,VAR_id : node(VAR_id, _, "rpg-domain-NoNeg.pddl.txt", _, _, _, _); -1,VAR_id : node(VAR_id, _, "rpggame_domain.pddl", _, _, _, _)} != 0.
edge(500, 0, "rpggame_domain.pddl", VAR_2, VAR_4, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, X153066778473426baef6d1c4a3b5be41, X184011f21acc41faa281c61499d7cbba); map(VAR_3, VAR_4, X6ea309f6ae4444539ac2e863ebbc0e1f, X9805054af68f4d7e9de52783e66a2947); edge(_, 1, "rpg-domain-NoNeg.pddl.txt", VAR_1, VAR_3, VAR_label, VAR_relation); not edge(_, 1, "rpggame_domain.pddl", VAR_2, VAR_4, VAR_label, VAR_relation).
edge(500, 0, "rpg-domain-NoNeg.pddl.txt", VAR_1, VAR_3, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, X7de34465aeaa44f5b5575ab21b8daf2f, Xcf7204628a204017b6e7e1950be2fd8f); map(VAR_3, VAR_4, X3cd8482b92bb4ce39c303dda2721a2dc, X68e0606d332b4d0795087275bfb25a4c); edge(_, 1, "rpggame_domain.pddl", VAR_2, VAR_4, VAR_label, VAR_relation); not edge(_, 1, "rpg-domain-NoNeg.pddl.txt", VAR_1, VAR_3, VAR_label, VAR_relation).
