...
(:action move-Load
:parameters (?obj - package ?truck1 - truck ?loc-from ?loc-to - location ?city1 - city)
:precondition (and
	(at-t ?truck1 ?loc-from) (in-city ?loc-from ?city1) (in-city ?loc-to ?city1) (at-p ?obj ?loc-to)
)
:effect
(and 
(not (at-t ?truck1 ?loc-from)) (at-t ?truck1 ?loc-to) (not (at-p ?obj ?loc-to)) (in-p ?obj ?truck1)
