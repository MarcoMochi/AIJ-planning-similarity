...
{elementToElement("R1", "A1,L1,S1", "Operator")}.
{elementToElement("R1", "A1,L1", "Operator")}.
{elementToElement("A1,L1,L2", "R1,R2", "Operator")}.
{elementToElement("A1,L1,L2", "A1,L1,S1", "Operator")}.
{elementToElement("A1,L1,L2", "A1,L1", "Operator")}.
{elementToElement("R1,R2", "A1,L1,S1", "Operator")}.
{elementToElement("R1,R2", "A1,L1", "Operator")}.
{elementToElement("A1,L1,S1", "A1,L1", "Operator")}.
{elementToElement("R1", "E1", "Predicate")}.
...
{elementToElement("E1", "R1,R2", "Predicate")}.
{elementToElement("E1", "L1,L2", "Predicate")}.
{elementToElement("E1", "O1", "Predicate")}.
{elementToElement("E1", "L1", "Predicate")}.
{elementToElement("R1,R2", "L1,L2", "Predicate")}.
{elementToElement("R1,R2", "O1", "Predicate")}.
{elementToElement("R1,R2", "L1", "Predicate")}.
{elementToElement("L1,L2", "O1", "Predicate")}.
{elementToElement("L1,L2", "L1", "Predicate")}.
{elementToElement("O1", "L1", "Predicate")}.
 :~ elementToElement(VAR_e1, VAR_e2, VAR_type). [1@1, VAR_e1,VAR_e2,VAR_type]
node(0, 1, "rpggame_domain.pddl", "move_with_sword", "Operator", "R1,R2", ('empty', 'empty')).
node(1, 1, "rpggame_domain.pddl", "pickup_sword", "Operator", "R1", ('empty', 'empty')).
...
node(7, 1, "rpggame_domain.pddl", "holding_sword", "Predicate", "E1", ('empty', 'empty')).
node(8, 1, "rpggame_domain.pddl", "empty_handed", "Predicate", "E1", ('empty', 'empty')).
node(9, 1, "rpggame_domain.pddl", "have_sword", "Predicate", "R1", ('empty', 'empty')).
node(10, 1, "rpggame_domain.pddl", "not_have_sword", "Predicate", "R1", ('empty', 'empty')).
node(11, 1, "rpggame_domain.pddl", "have_trap", "Predicate", "R1", ('empty', 'empty')).
node(12, 1, "rpggame_domain.pddl", "not_have_trap", "Predicate", "R1", ('empty', 'empty')).
node(13, 1, "rpggame_domain.pddl", "have_monster", "Predicate", "R1", ('empty', 'empty')).
node(14, 1, "rpggame_domain.pddl", "not_have_monster", "Predicate", "R1", ('empty', 'empty')).
node(15, 1, "rpggame_domain.pddl", "connected", "Predicate", "R1,R2", ('empty', 'empty')).
{node(16, 0, "rpggame_domain.pddl", "move-with-sword", "Operator", "A1,L1,L2", ('empty', 'empty'))}.
{node(17, 0, "rpggame_domain.pddl", "move-without-sword", "Operator", "A1,L1,L2", ('empty', 'empty'))}.
{node(18, 0, "rpggame_domain.pddl", "pickup-sword", "Operator", "A1,L1,S1", ('empty', 'empty'))}.
{node(19, 0, "rpggame_domain.pddl", "destroy-sword", "Operator", "A1,L1,S1", ('empty', 'empty'))}.
{node(20, 0, "rpggame_domain.pddl", "disarm-trap", "Operator", "A1,L1", ('empty', 'empty'))}.
{node(21, 0, "rpggame_domain.pddl", "exit", "Operator", "A1,L1", ('empty', 'empty'))}.
{node(22, 0, "rpggame_domain.pddl", "in", "Predicate", "L1,L2", ('empty', 'empty'))}.
{node(23, 0, "rpggame_domain.pddl", "connected", "Predicate", "L1,L2", ('empty', 'empty'))}.
{node(24, 0, "rpggame_domain.pddl", "has-sword", "Predicate", "O1", ('empty', 'empty'))}.
{node(25, 0, "rpggame_domain.pddl", "hands-free", "Predicate", "O1", ('empty', 'empty'))}.
{node(26, 0, "rpggame_domain.pddl", "destroyed", "Predicate", "L1", ('empty', 'empty'))}.
{node(27, 0, "rpggame_domain.pddl", "complete", "Predicate", "L1", ('empty', 'empty'))}.
{node(28, 0, "rpggame_domain.pddl", "has-trap", "Predicate", "L1", ('empty', 'empty'))}.
{node(29, 0, "rpggame_domain.pddl", "has-exit", "Predicate", "L1", ('empty', 'empty'))}.
{node(30, 0, "rpggame_domain.pddl", "has-monster", "Predicate", "L1", ('empty', 'empty'))}.
{node(31, 0, "rpggame_domain.pddl", "free-trap", "Predicate", "L1", ('empty', 'empty'))}.
{node(32, 0, "rpggame_domain.pddl", "free-monster", "Predicate", "L1", ('empty', 'empty'))}.
{node(33, 0, "rpggame_domain.pddl", "goal", "Predicate", "E1", ('empty', 'empty'))}.
...
node(17, 1, "rpg-domain-NoNeg.pddl.txt", "goal", "Predicate", "E1", ('empty', 'empty')).
edge(0, 1, "rpggame_domain.pddl", 0, 5, "pre", "Ra1=Rb1").
edge(1, 1, "rpggame_domain.pddl", 0, 15, "pre", "Ra1=Rb1,Ra2=Rb2").
edge(2, 1, "rpggame_domain.pddl", 0, 7, "pre", "").
edge(3, 1, "rpggame_domain.pddl", 0, 12, "pre", "Ra1=Rb2").
edge(4, 1, "rpggame_domain.pddl", 0, 6, "pre", "Ra1=Rb2").
edge(5, 1, "rpggame_domain.pddl", 0, 5, "del", "Ra1=Rb1").
edge(6, 1, "rpggame_domain.pddl", 0, 6, "del", "Ra1=Rb2").
edge(7, 1, "rpggame_domain.pddl", 0, 5, "add", "Ra1=Rb2").
edge(8, 1, "rpggame_domain.pddl", 1, 5, "pre", "Ra1=Rb1").
edge(9, 1, "rpggame_domain.pddl", 1, 8, "pre", "").
edge(10, 1, "rpggame_domain.pddl", 1, 9, "pre", "Ra1=Rb1").
edge(11, 1, "rpggame_domain.pddl", 1, 12, "pre", "Ra1=Rb1").
edge(12, 1, "rpggame_domain.pddl", 1, 14, "pre", "Ra1=Rb1").
edge(13, 1, "rpggame_domain.pddl", 1, 7, "add", "").
edge(14, 1, "rpggame_domain.pddl", 1, 8, "del", "").
...
node(VAR_id, 1, VAR_graph, VAR_name, VAR_type, VAR_elements1, (VAR_elements2, VAR_elements1)) :- node(VAR_id, 1, VAR_graph, VAR_name, VAR_type, VAR_elements2, _); elementToElement(VAR_elements2, VAR_elements1, VAR_type).
 :- node(VAR_id, _, "rpg-domain-NoNeg.pddl.txt", _, _, _, _); #count{VAR_v : map(VAR_v, VAR_id, Xd26a612068704ba09660ed779d88d661, X347a7612c41a4b3b8f0779e1c65e5b7a)} != 1.
 :- #sum{1,VAR_id : node(VAR_id, _, "rpggame_domain.pddl", _, _, _, _); -1,VAR_id : node(VAR_id, _, "rpg-domain-NoNeg.pddl.txt", _, _, _, _)} != 0.
edge(500, 0, "rpg-domain-NoNeg.pddl.txt", VAR_2, VAR_4, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, X9d095ba7c3b64c08a5e1610f3c9dc006, X216124989bf04973badeb95e18ab3264); map(VAR_3, VAR_4, Xa45b2ac72fce4df58a9a2ebdc1f7dee4, X3660700414d24e3e80afacd294192dab); edge(_, 1, "rpggame_domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation); not edge(_, 1, "rpg-domain-NoNeg.pddl.txt", VAR_2, VAR_4, VAR_label, VAR_relation).
edge(500, 0, "rpggame_domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation) :- map(VAR_1, VAR_2, Xa601baf06a4147339bbdbc0074cec81a, Xa5bc20a81c554461b068d57749266bcb); map(VAR_3, VAR_4, X5b0e97a196a847d48212767e3abcc4e7, X825daf49020c4f88961cfd9b0be055b7); edge(_, 1, "rpg-domain-NoNeg.pddl.txt", VAR_2, VAR_4, VAR_label, VAR_relation); not edge(_, 1, "rpggame_domain.pddl", VAR_1, VAR_3, VAR_label, VAR_relation).
